...
public class IterUtil {
     ...
     * @since 5.2.6
     */
    public static <K, V> Map<K, V> toMap(Iterator<V> iterator, Map<K, V> map, Func<V, K> keyFunc) {
     ...
     * @since 5.2.6
     */
    public static <K, V, E> Map<K, V> toMap(Iterator<E> iterator, Map<K, V> map, Func<E, K> keyFunc, Func<E, V> valueFunc) {
        if (null == iterator) {
            return map;
        }

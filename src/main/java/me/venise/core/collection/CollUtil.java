...
import me.venise.core.comparator.PinyinComparator;
import me.venise.core.comparator.PropertyComparator;
...
import me.venise.core.lang.hash.Hash32;
...
public class CollUtil {
     ...
     * @since 5.2.6
     */
    public static <K, V> Map<K, V> toMap(Iterable<V> values, Map<K, V> map, Func<V, K> keyFunc) {
     ...
     * @since 5.2.6
     */
    public static <K, V, E> Map<K, V> toMap(Iterable<E> values, Map<K, V> map, Func<E, K> keyFunc, Func<E, V> valueFunc) {

package me.venise.core.text;

import me.venise.core.comparator.VersionComparator;
...
public class CharSequenceUtil {
     ...
     * @return 替换后的字符串
     * @see RegexUtil#replaceAll(CharSequence, java.util.regex.Pattern, Func)
     * @since 4.2.2
     */
    public static String replace(CharSequence str, java.util.regex.Pattern pattern, Func<java.util.regex.Matcher, String> replaceFun) {
     ...
     * @param replaceFun 决定如何替换的函数
     * @return 替换后的字符串
     * @see RegexUtil#replaceAll(CharSequence, String, Func)
     * @since 4.2.2
     */
    public static String replace(CharSequence str, String regex, Func<java.util.regex.Matcher, String> replaceFun) {

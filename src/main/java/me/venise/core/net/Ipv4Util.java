...
import me.venise.core.collection.ListUtil;
import me.venise.core.convert.Convert;
import me.venise.core.lang.Assert;
import me.venise.core.lang.Validator;
...
public class Ipv4Util {
    ...
    public static List<String> list(String ipRange, boolean isAll) {
        if (ipRange.contains(IP_SPLIT_MARK)) {
            // X.X.X.X-X.X.X.X
            final String[] range = StringUtil.split(ipRange, IP_SPLIT_MARK);
            return list(range[0], range[1]);
        } else if (ipRange.contains(IP_MASK_SPLIT_MARK)) {
            // X.X.X.X/X
            final String[] param = StringUtil.split(ipRange, IP_MASK_SPLIT_MARK);
    ...
    public static int getMaskBitByMask(String mask) {
        ...
        int inetmask = 0;
        int count;
        for (String part : StringUtil.split(mask, CharUtil.DOT)) {
